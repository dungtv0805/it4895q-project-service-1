...
public class LoginController {
	...
	public ResponseEntity<?> createAuthenticationToken(@RequestBody LoginRequest authencationRequest) throws Exception {
		authenticate(authencationRequest.getUsername(), authencationRequest.getPassword());

		final UserDetails userDetails = userDetailsService.loadUserByUsername(authencationRequest.getUsername());
	...
	public void saveUser(@RequestBody RegisterRequest user) throws Exception {
